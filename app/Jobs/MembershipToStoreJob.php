...
use App\Mail\MembershipToStore;

class MembershipToStoreJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $blogPost = BlogPost::where(['template_name'=>2])->first();
        ...
        Mail::to("denizci_denizci2000@hotmail.com")->queue(new MembershipToStore([
