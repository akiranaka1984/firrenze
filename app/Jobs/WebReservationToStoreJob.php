...
use App\Mail\WebReservationToStore;

class WebReservationToStoreJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $blogPost = BlogPost::where(['template_name'=>6])->first();
        ...
        Mail::to("denizci_denizci2000@hotmail.com")->queue(new WebReservationToStore([
