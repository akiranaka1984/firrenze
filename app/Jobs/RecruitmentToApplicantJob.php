...
use App\Mail\RecruitmentToApplicant;

class RecruitmentToApplicantJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $blogPost = BlogPost::where(['template_name'=>7])->first();
        ...
        Mail::to($interview->mail)->queue(new RecruitmentToApplicant([
