...
<head>
    <!-- ここに挿入 -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-KG0MWX6QRN"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-KG0MWX6QRN');
    </script>
    <meta charset="UTF-8">
    <meta name="keywords" content="デリヘル,美人,風俗,六本木,西麻布,高級,美女">
    ...
    <meta property="og:site_name" content="【最高級デリヘル】クラブフィレンツェ">
    <meta property="og:title" content="【最高級デリヘル】クラブフィレンツェ">
    ...
    <script src="https://kit.fontawesome.com/e1c9d8bfb9.js" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="{{ url('assets/css/detail.css') }}" type="text/css" media="all">
...
<script type="text/javascript" src="https://code.jquery.com/jquery-3.7.0.min.js?ver=3.7.0"></script>
<script type="text/javascript" src="https://unpkg.com/web-animations-js@2.3.2/web-animations.min.js"></script>
<script type="text/javascript" src="https://unpkg.com/muuri@0.8.0/dist/muuri.min.js"></script>
<script src="https://unpkg.com/imagesloaded@5/imagesloaded.pkgd.min.js"></script>

<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery-datetimepicker/2.5.20/jquery.datetimepicker.full.min.js?ver=6.4.3"></script>
